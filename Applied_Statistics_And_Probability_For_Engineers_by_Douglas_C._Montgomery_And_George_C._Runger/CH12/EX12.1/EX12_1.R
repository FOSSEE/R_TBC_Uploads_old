...
cat("the fitted regression equation is y =",round(model$coefficients[1], digits = 5),"+",round(model$coefficients[2], digits = 5),"x1 + ",round(model$coefficients[3], digits = 5),"x2")