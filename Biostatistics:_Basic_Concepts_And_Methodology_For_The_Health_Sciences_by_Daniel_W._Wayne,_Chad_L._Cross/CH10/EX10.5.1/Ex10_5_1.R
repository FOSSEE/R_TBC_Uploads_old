##Example 10.5.1 Pg.508
##95% confidencec interval for CDA
...
new.dat <- data.frame(age=68,edlevel=12)    #new observation
predict(reg, newdata = new.dat, interval = 'confidence')  #confidence interval
predict(reg, newdata = new.dat, interval = 'prediction')  #prediction interval
