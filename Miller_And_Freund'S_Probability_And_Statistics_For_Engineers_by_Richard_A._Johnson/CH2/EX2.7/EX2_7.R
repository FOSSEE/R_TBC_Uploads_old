#density histogram
#58 specimens of new aluminum alloy undergoing development
data<-c(66.4,67.7,68.0,68.0,68.3,68.4,68.6,68.8,68.9,69.0,69.1,
...
hist(data,freq=FALSE,xlab="Teansile Strength")
lines(density(data))
