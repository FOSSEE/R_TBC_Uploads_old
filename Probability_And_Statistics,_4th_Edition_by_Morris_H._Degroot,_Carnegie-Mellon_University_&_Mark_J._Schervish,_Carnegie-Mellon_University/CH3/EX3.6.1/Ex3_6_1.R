# Chapter 3 - Random Variables and Distributions, Section - 3.6 (Conditional Distributions), Page No. - 142

# Joint probability of a car not getting stolen is represented by 'x1'.
# Joint probability of a car getting stolen is represented by 'x2'.
# In order to define a vector, "vector" function is used.
# For description of this function, type ?vector in the console.

x1<-c(0.129,0.298,0.161,0.280,0.108);
x2<-c(0.010,0.010,0.001,0.002,0.001);
x<-c(x1,x2);
...
f<-matrix(x,nrow=2,ncol=5,byrow=TRUE);
